    ...
    <footer className="bg-brand-dark text-white mt-12">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold text-brand-orange mb-4">Gadgets</h3>
            <p className="text-gray-300 mb-4">
              Your trusted partner for the latest technology and electronics. 
              We bring you premium quality products at the best prices.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="#" className="hover:text-brand-orange transition-colors">Smartphones</a></li>
              <li><a href="#" className="hover:text-brand-orange transition-colors">Laptops</a></li>
              <li><a href="#" className="hover:text-brand-orange transition-colors">Tablets</a></li>
              <li><a href="#" className="hover:text-brand-orange transition-colors">Accessories</a></li>
              <li><a href="#" className="hover:text-brand-orange transition-colors">Smart Home</a></li>
              <li><a href="#" className="hover:text-brand-orange transition-colors">Gaming</a></li>
            </ul>
          </div>
